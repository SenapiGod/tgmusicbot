    ...
    if audio:
        if round(audio.duration / 60) > DURATION_LIMIT:
            raise DurationLimitError(
                f"**𝐏𝐥𝐚𝐲 𝐌𝐮𝐬𝐢𝐜 𝐋𝐞𝐬𝐬 \n𝐓𝐡𝐚𝐧 {DURATION_LIMIT} 𝐌𝐢𝐧𝐮𝐭𝐞s ...**"
            )

        file_name = get_file_name(audio)
        title = file_name
        thumb_name = "https://telegra.ph/file/dbf44574843622dc7061c.jpg"
